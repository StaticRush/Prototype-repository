    ...
    {
        {
            if (column > 0 && column < board.width - 1)
            {
                ...
                if (leftDot1 != null && rightDot1 != null)
                {
                    ...
                    {
                        leftDot1.GetComponent<Gems>().isMatched = true;
                        rightDot1.GetComponent<Gems>().isMatched = true;
                        isMatched = true;
                    }
                }
            }
            if (row > 0 && row < board.height - 1)
            {
                ...
                if (upDot1 != null && downDot1 != null)
                {
                    ...
                    {
                        upDot1.GetComponent<Gems>().isMatched = true;
                        downDot1.GetComponent<Gems>().isMatched = true;
                        isMatched = true;
                    }
                }
            }
